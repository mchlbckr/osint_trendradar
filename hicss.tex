...
six successive activities \cite{Peffers.2007} (see figure 1).
...
To standardize the approach across the Intelligence Cycle, general categories were defined for each phase, excluding the evaluation/feedback phase due to its iterative nature. For the collection phase, six categories were developed:
\begin{itemize}
