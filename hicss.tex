...
We will discuss steps 2-5 indetail, while the first step is summarized in section \ref{sec:introduction} and results of step 6 are described in sections \ref{sec:results} and \ref{sec:discussion}. Steps 1-4 were continuously evaluated during the study \cite{Sonnenberg.2012}.
