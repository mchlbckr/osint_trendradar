...
\begin{figure*}[thb]
    \centering
    \includegraphics[width=\textwidth]{DSRM-cropped}
...
\begin{figure*}[thb]
    \centering
    \includegraphics[width=\textwidth]{crop_Kategorisierungskriterien und Literraturreviewaufbau}
...
studies could be identified on general approaches to creating knowledge graphs \cite{Hu.2023,Ma.2022}.
...
faster data collection (cf. \cite{Jenkins.2021,Rajendran.2022}). Another method in the prototype phase is
...
\cite{Bai.2020,Pingle.2020,Shen.2020}. However, they note that
...
"Supervised Support Vector Machines" (SVM) (see e.g.:\cite{Iorga.2020}) are listed in the literature.
...
except for cases like Dale et al. \cite{Dale.2023}, who developed a bidirectional recurrent neural network with
...
are utilized to create dashboards and visualization maps., user interfaces,
...
This involves not only national but also European-level considerations, such as GDPR regulations on personal data protection
\cite{EuropeanParliament.2016,EuropeanCommission.18.08.2023, taking into account not solely
individual but societal impacts \cite{Ghioni.2023}. To date, these topics remain
underexplored \cite{Ghioni.2023,Wittmer.2022}. (RG6) Addressing these
...
it could not be verified whether only public sources \cite{NorthAtlanticTreatyOrganization.2002} were actually used
