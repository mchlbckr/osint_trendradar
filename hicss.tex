...
\cite{Schaurer.2010, NorthAtlanticTreatyOrganization.2001}.

\subsection{Open Source Information (OSIF)}

Before intelligence can be obtained from OSD, they must undergo a preparation process that includes filtering, validation and
...
criteria \cite{Sonnenberg.2012} are thus demonstrably fulfilled in practice.
