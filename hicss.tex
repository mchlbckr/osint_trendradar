...
create the trend radar. It consists of six successive activities (see figure \ref{fig: DSRM}) \cite{Peffers.2007}.
...
First, the research problem must be defined and the benefits of the solution explained (see section \ref{sec:introduction}).
