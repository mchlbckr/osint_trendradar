...
The experts (see \reference{tab: experts}) were selected according to the method of
...
\begin{table}[]
    ...
    \begin{tabular}[h]{l||r}
        ...
        \hline
        Start-up           & Co-Founder, Managing Director 
                            of a German start-up, for an 
                            OSINT platform                  & E4                                            \\
    \end{tabular}
\end{table}
...
To compare it with the with the respondents' practical experience, open questions
were asked for each phase. These reduce the influence of
subjectivity [73]. Exploratory questions were added to direct the flow of conversation
    [73]. At the third level, specific closed questions for targeted follow-up
queries were asked [73]. he interviews lasted up to one hour, with a maximum of three
main questions for each section [25] (see Respository X). The questionnaire
