...
\maketitle
\begin{abstract}
    \\The abstract is to be in fully-justified italicized text, at the top of the left-hand column as it is here, below the author information. Use the word “Abstract” as the title, in 12-point Times, boldface \\\\\type, centered relative to the column, initially capitalized. The abstract is to be in 10-point, single-spaced type, and up to 150 words in length. Leave two blank lines after the abstract, and then begin the \\\\main text.
    Open Source Intelligence (OSINT) currently com-mands attention, notably heightened since the Rus-sian invasion of Ukraine. Despite attempts at stand-ardized definitions, the intelligence discipline remains ambiguous. This paper introduces a practice-validated OSINT trend radar, categorizing technolo-gies by maturity, intelligence cycle phase, and use case. Serving as a profound knowledge base and tool for identifying research gaps, the radar emerges from a structured design process. Sixty studies underwent categorization and validation through expert inter-views, revealing the absence of a comprehensive, automated third-generation OSINT system in Germa-ny. Technological gaps, especially in planning, direc-tion, dissemination, and integration phases, are evi-dent. Despite identifying intelligent support technolo-gies, practical implementation lags theory. The hu-man factor therefore remains central to the OSINT process. Future research should prioritize developing applications for underserved phases, probing reasons for limited widespread implementation of proven applications, with emphasis on legal, ethical, political, and social parameters.
