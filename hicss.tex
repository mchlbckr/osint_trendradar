...
\begin{abstract}
    ...
    revealing the absence of an autonomous third-generation OSINT
    ...
    applications for underserved phases and examine why proven applications are not widely
...
interviews with security sector experts \cite{Bogner.2014}, and evaluated using qualitative content analysis \cite{Billings.1997}. All background material for this research, such as concept matrices and code, is openly available on GitHub \cite{kayser2024}.
...
\begin{figure}[h]
    ...
    \caption{Intelligence Cycle, according to \cite{JointChiefsofStaffU.S.Army.2013} consisting of the five iterative phases and the unterlying evaluation and feedback}
...
publications are fewer compared to other trending topics. In 2021, \cite{Yogish.2021} explored AI (Artificial Intelligence) implementation in cyber security,
