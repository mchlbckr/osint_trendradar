...
Sections \ref{sec:introduction} summarizes step 1 and sektions \ref{sec:results} and \ref{sec:discussion} the results of step 6. Steps 2-5 will be discussed in detail. Continuous evaluation of steps 1-4 occurred throughout the study \cite{Sonnenberg.2012}.
