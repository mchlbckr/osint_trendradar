...
The trend radar (see Fig. X) is to be read from the outside in. 
Each of the fifths of the cycle represents a phase of the Intelligence Cycle. 
The further subdivision reflects the phase-specific use cases. The color 
gradations represent the maturity levels. The numbered black and white dots 
represent the grouped technologies. A boxplot-like representation indicates 
that the technologies exist at different levels of maturity.
